...
EXTEND_BOTTOM BDSCHAEL 20 21 23
	...
	IF ~Global("#L_AcceptedRoom","GLOBAL",1)~ THEN EXTERN ~BDBELT~ BELT_HAVE_ROOM
END
...
APPEND BDBELT
	...
	IF ~~ THEN BELT_SNARK
		...
		++ @2449 /* ~Do you know where it is?  I do.  It was stolen from you and sent to Athkatla at the request of some mysterious 'hooded man'.~ */ DO ~SetGlobal("#L_BeltHoodedMan","GLOBAL",1)~ + BELT_SNARK_2
	END
	...
	IF ~~ THEN BELT_WEAK_POISON
		...
		IF ~Global("#L_BeltHoodedMan","GLOBAL",0)~ THEN REPLY @2461 /* ~Even more disturbing was the visitor I had.  It seems a mysterious hooded man is stalking me.~ */ + BELT_SORRY
		IF ~!Global("#L_BeltHoodedMan","GLOBAL",0)~ THEN REPLY @2461 /* ~Even more disturbing was the visitor I had.  It seems a mysterious hooded man is stalking me.~ */ + BELT_SAME_HOODED_MAN
	END
